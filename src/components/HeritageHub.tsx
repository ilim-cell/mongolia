        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          <div className="space-y-12 order-2 lg:order-1">
            <div className="space-y-6">
              ...
              <p className="text-lg md:text-xl text-black/60 max-w-md font-light leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {cards.map((card, idx) => (
                <div key={idx} className="p-8 border border-black/10 hover:border-black transition-all group bg-white">
          ...
          <div className="relative aspect-[4/5] overflow-hidden order-1 lg:order-2 group bg-slate-50 border border-black/5">
            <Image
              src={Images.heritage.detailed}
              alt="Detailed Nomadic Life"
              fill
              unoptimized
            ...
            <div className="absolute inset-x-0 bottom-0 p-8 md:p-12 glass-dark text-white">
              <p className="text-6xl md:text-9xl font-headline font-black mb-2 leading-none">{uiText["ui.heritage.stats.value"]}</p>
